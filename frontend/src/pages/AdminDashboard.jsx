...
import { Plus, ToggleLeft, ToggleRight, List, UserCheck, Activity, AlertCircle, ShieldCheck, Mail, User, Stethoscope, Lock } from 'lucide-react';
...
const AdminDashboard = () => {
  ...
  const [activeForm, setActiveForm] = useState('services'); // 'services', 'add-admin', or 'add-doctor'
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-12">
      ...
      <div className="bg-white rounded-3xl border border-slate-100 p-6 sm:p-8 shadow-xs flex flex-col md:flex-row md:items-center justify-between gap-6 text-left relative overflow-hidden">
        ...
        <div className="flex flex-wrap gap-2 bg-slate-100 p-1.5 rounded-2xl">
          ...
          <button
            onClick={() => { setActiveForm('add-doctor'); setErrorMsg(''); setSuccessMsg(''); }}
            className={`px-4 py-2 text-xs font-bold rounded-xl transition-all cursor-pointer flex items-center gap-1.5 ${
